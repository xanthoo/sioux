...
public class AppointmentMemoryRepository implements IAppointmentRepository {
    ...
    public AppointmentMemoryRepository(){
        ...
        appointmentList.add(new Appointment("Test event", 0, LocalDateTime.now(), new Visitor(0, "Piet", "123-abc-45", "0612345678", "Needs a whiteboard.")));
        appointmentList.add(new Appointment("Test event 2", 1, LocalDateTime.now(),new Visitor(0, "Piet", "123-abc-45", "0612345678", "Needs a whiteboard.")));
        appointmentList.add(new Appointment("Test event 3", 2, LocalDateTime.now(), new Visitor(2, "Jan", "456-def-78", "0690123456", "Brings his assistant with him.")));
    }
